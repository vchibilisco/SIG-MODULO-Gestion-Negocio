        ...
        try {
            ...
            if (indextabla > -1) {
                try {
                    ...
                    Integer cup = (Integer) modelo.getValueAt(idx, 0);
                    ...
                    CONTROLADOR_V.agregarProducto(cup, stockIng, costoTotal);
            ...
            JOptionPane.showMessageDialog(this, "Seleccione un producto por favor.", "Error", JOptionPane.ERROR_MESSAGE);
        } catch (Exception e) {
            e.printStackTrace();
            JOptionPane.showMessageDialog(this, "Ingrese un número entero por favor.", "Error", JOptionPane.ERROR_MESSAGE);
        }
    }
