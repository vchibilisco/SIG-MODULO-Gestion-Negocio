 ...
 * @author vicente-dell
 */
public class AMProveedor extends javax.swing.JDialog {
     ...
     */
    public AMProveedor(java.awt.Frame parent, boolean modal, String opcion) {
        super(parent, modal);
        initComponents();
        this.opcion = opcion;
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                ...
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addGroup(jPanel1Layout.createSequentialGroup()
                                        ...
                                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                            ...
                                            .addComponent(listaLocal, 0, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)))
                                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                                        .addGap(18, 18, 18)
                                        .addComponent(listaCP, javax.swing.GroupLayout.PREFERRED_SIZE, 287, javax.swing.GroupLayout.PREFERRED_SIZE)))
                                .addGap(18, 18, 18)
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addComponent(txtContacto, javax.swing.GroupLayout.PREFERRED_SIZE, 168, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void listaPaisActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_listaPaisActionPerformed
        ...
        if (!pais.equals("Seleccione un Pais")) {
            ArrayList<String> listaProvincia = CONTROLADOR_V.recuperarProvincia(pais);
    ...
    private void listaLocalActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_listaLocalActionPerformed
        ...
        if (!loc.equals("Seleccione una Localidad")) {
            ArrayList<String> listaCP = CONTROLADOR_V.recuperarCP(loc);
                            ...
                            if (Validacion.validarNumero(this.txtPreCuit.getText() + this.txtNumCuit.getText() + this.txtPosCuit.getText())) {
                                if (Validacion.validarNumero(this.txtCodArea.getText()) && this.txtCodArea.getText().length() <= 4 && !this.txtCodArea.getText().startsWith("0")) {
                                    if (Validacion.validarNumero(this.txtNumTel.getText()) && this.txtNumTel.getText().length() <= 7 && !this.txtNumTel.getText().startsWith("0")) {
                                        String pais = (String) this.listaPais.getSelectedItem();
                                        if (!this.txtContacto.getText().equals("")) {
                                            if (!pais.equals("Seleccione un Pais")) {
                                                        ...
                                                        if (!cp.equals("Seleccione un Codigo Postal")) {
                                                            if (!this.txtCalle.getText().equals("")) {
                                                                if (!this.txtNumCalle.getText().equals("") && Validacion.validarNumero(this.txtNumCalle.getText())) {
                                                                    this.domicilio = "Calle: " + this.txtCalle.getText().toUpperCase() + " %Nro: " + this.txtNumCalle.getText().toUpperCase() + " Piso: " + this.txtPiso.getText().toUpperCase() + " Dpto: " + this.txtDep.getText().toUpperCase();
                                                                    ...
                                                                    switch (this.opcion) {
                                                                        case "Alta":
                                                                            if (CONTROLADOR_V.altaProveedor(cuit, this.txtRazonSocial.getText().toUpperCase(), rs, telefono, this.txtContacto.getText().toUpperCase(), this.txtObservacion.getText().toUpperCase(), domicilio, pais, provincia, localidad, Integer.parseInt((String) this.listaCP.getSelectedItem()))) {
                                                                            ...
                                                                            break;
                                                                        case "Modificar":
                                                                            if (CONTROLADOR_V.modificarProveedor(cuit, this.txtRazonSocial.getText().toUpperCase(), rs, telefono, this.txtContacto.getText().toUpperCase(), this.txtObservacion.getText().toUpperCase(), domicilio, pais, provincia, localidad, Integer.parseInt((String) this.listaCP.getSelectedItem()))) {
                                            ...
                                            JOptionPane.showMessageDialog(this, "No puede estar vacion", "Error", JOptionPane.ERROR_MESSAGE);
    ...
    private void formWindowClosing(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowClosing
        int op = JOptionPane.showConfirmDialog(this, "¿Desea cerrar la ventana de Proveedor?.\n"
